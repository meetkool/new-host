      ...
      <section className="bg-gradient-to-br from-purple-600 to-purple-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Badge className="mb-4 bg-white text-purple-600 hover:bg-gray-100">
                ...
                <CardContent className="pt-6">
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <div className="mt-6 p-4 bg-purple-50 rounded-lg border border-purple-200">
                        <div className="text-2xl font-bold text-purple-700">{program.price}</div>
                        <div className="text-sm text-purple-600">Complete program fee</div>
                        <div className="text-xs text-purple-500 mt-1">30% discount vs classroom</div>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-8">
                    ...
                    <Button 
                      size="lg"
                      variant="outline"
                      className="border-2 border-purple-600 text-purple-600 hover:bg-purple-50 flex-1"
                    >
                      Free Demo Class
                    </Button>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-video bg-gradient-to-br from-purple-400 to-purple-600 rounded-2xl flex items-center justify-center">
                <PlayCircle className="w-24 h-24 text-white" />
              </div>
              <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-lg shadow-xl border border-purple-100">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              size="lg"
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-purple-600 text-lg px-8"
              onClick={() => navigate('/scholarship-test')}
            >
