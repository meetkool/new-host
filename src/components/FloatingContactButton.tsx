...
const FloatingContactButton: React.FC<FloatingContactButtonProps> = ({
  whatsappNumber = '917303577006',
  phoneNumber = '+917303577006',
  ...
  return (
    ...
    >
      ...
      {/* Dropdown Menu */}
      <div
        className={`absolute bottom-[70px] left-0 min-w-[140px] md:min-w-[160px] shadow-xl rounded-lg overflow-hidden transition-all duration-300 ${isOpen ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 translate-y-2 pointer-events-none'
          }`}
        onMouseEnter={showDropup}
        onMouseLeave={hideDropup}
      >
